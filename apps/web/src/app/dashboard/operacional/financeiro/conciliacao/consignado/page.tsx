  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Link className="group rounded border border-slate-200 bg-white p-5 shadow-executive transition hover:border-primary/40" href="/dashboard/operacional/financeiro/conciliacao/consignado/baixas">
          <div className="flex justify-between"><FileCheck2 className="h-5 w-5 text-primary" /><ArrowRight className="h-4 w-4 text-slate-400 transition group-hover:translate-x-1" /></div><h3 className="mt-4 font-semibold">Baixas e remessas</h3><p className="mt-1 text-sm text-slate-500">BMP, UY3, matching e remessa Daycoval.</p>
        </Link>
        <Link className="group rounded border border-slate-200 bg-white p-5 shadow-executive transition hover:border-primary/40" href="/dashboard/operacional/financeiro/conciliacao/consignado/conciliacao-bancaria">
          <div className="flex justify-between"><Landmark className="h-5 w-5 text-primary" /><ArrowRight className="h-4 w-4 text-slate-400 transition group-hover:translate-x-1" /></div><h3 className="mt-4 font-semibold">Conciliação bancária</h3><p className="mt-1 text-sm text-slate-500">Entradas Bradesco e remessas muitos-para-muitos.</p>
        </Link>
      </div>
    </div>
  );
