...
import { createBankReconciliation, describeBankReconciliationError } from "@/server/operational/consignado-bank-service";
...
export async function POST(request: NextRequest) {
  ...
  catch (error) { return NextResponse.json({ ok: false, message: describeBankReconciliationError(error) }, { status: 400 }); }
}
